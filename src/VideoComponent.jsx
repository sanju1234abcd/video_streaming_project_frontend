    ...
    return( 
        <div className="video" onClick={()=>{navigate(`/videoPlayer/${_id}`)}}>
            ...
            <div className="details-section">
                ...
                <img src={Avatar} onClick={(event)=>{event.stopPropagation();navigate(`/channel/${owner}`)}} style={{height:'30px',width:'30px',borderRadius:'50%',objectFit:'cover',backgroundPosition:'center',cursor:'pointer'}}/>
                
                <h3 style={{fontSize:'15.5px'}}>{(title.length > 30) ? (title.substr(0,30) + '...') : title}</h3>
            </div>
